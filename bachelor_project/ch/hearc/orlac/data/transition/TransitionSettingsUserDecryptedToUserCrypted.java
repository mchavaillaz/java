...
/**
 * Contains the settings of the transition from STATE_USER_DECRYPTED to STATE_USER_CRYPTED.
 * @author chavailm
 */
public class TransitionSettingsUserDecryptedToUserCrypted extends TransitionSettings_A
	{

	/*------------------------------------------------------------------*\
	|*							Constructeurs							*|
	\*------------------------------------------------------------------*/
	public TransitionSettingsUserDecryptedToUserCrypted()
		{
		this.transitionDurationInSeconds = Settings.TRANSITION_DURATION_USER_DECRYPTED_TO_USER_CRYPTED;
		}
	...
	public void setTransitionDurationInSeconds(double _transitionDurationInSeconds)
		...
		this.transitionMachine.setDurationUserEncryptToUserCryptedSeconds(this.transitionDurationInSeconds);
