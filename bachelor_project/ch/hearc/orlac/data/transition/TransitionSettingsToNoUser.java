...
/**
 * Contains the settings of the transition from ANY_STATE to STATE_NO_USER.
 * @author chavailm
 */
public class TransitionSettingsToNoUser extends TransitionSettings_A
	{

	/*------------------------------------------------------------------*\
	|*							Constructeurs							*|
	\*------------------------------------------------------------------*/
	public TransitionSettingsToNoUser()
		{
		this.transitionDurationInSeconds = Settings.TRANSITION_DURATION_TO_NO_USER;
		}
	...
	public void setTransitionDurationInSeconds(double _transitionDurationInSeconds)
		...
		this.transitionMachine.setDurationNoUserEncryptToNoUserSeconds(this.transitionDurationInSeconds);
